...
export const mockAppointments = [
  ...
  // Past appointments — populates Leaderboard + Analytics historical metrics.
  // Distribution across the 4 leaderboard windows (today/week/month/quarter)
  // with realistic solar close-rate mix: ~25% closed-won, ~60% sat-no-close,
  // ~15% no-show/canceled.
  { id: 'p1',  date: dateStr(-1),  time: '9:00 AM',   type: 'appointment',  status: 'completed',          customer: 'Nguyen Family',     address: '14 Bay St, Norwalk, CT 06851',            zipCode: '06851', consultant: 'ct-1',   designExpert: 'de-jr', territory: 'CT',   isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p2',  date: dateStr(-1),  time: '2:00 PM',   type: 'appointment',  status: 'closed-won',         customer: 'Goldberg Family',   address: '88 Atlantic Ave, Brooklyn, NY 11201',     zipCode: '11201', consultant: 'nyw-1',  designExpert: 'de-bk', territory: 'NYW',  isVirtual: false, isPlaceholder: false, leadSource: 'get_the_referral' },
  { id: 'p3',  date: dateStr(-2),  time: '11:30 AM',  type: 'appointment',  status: 'completed',          customer: 'Reilly Family',     address: '210 Hope St, Stamford, CT 06906',         zipCode: '06906', consultant: 'ct-4',   designExpert: 'de-jr', territory: 'CT',   isVirtual: false, isPlaceholder: false, leadSource: 'self_gen' },
  { id: 'p4',  date: dateStr(-3),  time: '5:00 PM',   type: 'appointment',  status: 'closed-won',         customer: 'Singh Family',      address: '402 Kennedy Blvd, Manalapan, NJ 07726',  zipCode: '07726', consultant: 'njpa-1', designExpert: null,    territory: 'NJPA', isVirtual: false, isPlaceholder: false, leadSource: 'partner' },
  { id: 'p5',  date: dateStr(-3),  time: '2:00 PM',   type: 'appointment',  status: 'completed',          customer: 'Park Family',       address: '17 Federal Hill, Baltimore, MD 21230',    zipCode: '21230', consultant: 'md-6',   designExpert: null,    territory: 'MD',   isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p6',  date: dateStr(-5),  time: '11:30 AM',  type: 'appointment',  status: 'no-show',            customer: 'Ferreira Family',   address: '92 Atwells Ave, Providence, RI 02903',    zipCode: '02903', consultant: 'mari-1', designExpert: 'de-nm', territory: 'MARI', isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p7',  date: dateStr(-7),  time: '9:00 AM',   type: 'appointment',  status: 'closed-won',         customer: 'Hayes Family',      address: '36 Westport Ave, Norwalk, CT 06851',      zipCode: '06851', consultant: 'ct-1',   designExpert: 'de-jr', territory: 'CT',   isVirtual: false, isPlaceholder: false, leadSource: 'inbound' },
  { id: 'p8',  date: dateStr(-10), time: '2:00 PM',   type: 'appointment',  status: 'completed',          customer: 'Schwartz Family',   address: '120 W 86th, Manhattan, NY 10024',         zipCode: '10024', consultant: 'nyw-2',  designExpert: 'de-bk', territory: 'NYW',  isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p9',  date: dateStr(-14), time: '5:00 PM',   type: 'appointment',  status: 'completed',          customer: 'Ouellette Family',  address: '55 Forest Ave, Portland, ME 04101',       zipCode: '04101', consultant: 'menh-1', designExpert: 'de-sg', territory: 'MENH', isVirtual: true,  isPlaceholder: false, leadSource: 'event' },
  { id: 'p10', date: dateStr(-21), time: '11:30 AM',  type: 'appointment',  status: 'canceled',           customer: 'O’Brien Family', address: '308 Liberty St, Bayonne, NJ 07002',     zipCode: '07002', consultant: 'njpa-3', designExpert: null,    territory: 'NJPA', isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p11', date: dateStr(-28), time: '9:00 AM',   type: 'appointment',  status: 'completed',          customer: 'Bianchi Family',    address: '14 Pequot Ave, Stamford, CT 06902',       zipCode: '06902', consultant: 'ct-4',   designExpert: 'de-jr', territory: 'CT',   isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p12', date: dateStr(-35), time: '2:00 PM',   type: 'appointment',  status: 'closed-won',         customer: 'MacDonald Family',  address: '21 State St, Portsmouth, NH 03801',       zipCode: '03801', consultant: 'menh-7', designExpert: 'de-sg', territory: 'MENH', isVirtual: false, isPlaceholder: false, leadSource: 'retail' },
  { id: 'p13', date: dateStr(-45), time: '5:00 PM',   type: 'appointment',  status: 'no-show',            customer: 'Russo Family',      address: '7 Maple Hill, Enfield, CT 06082',         zipCode: '06082', consultant: 'ct-2',   designExpert: 'de-jr', territory: 'CT',   isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
  { id: 'p14', date: dateStr(-55), time: '9:00 AM',   type: 'appointment',  status: 'closed-won',         customer: 'Costa Family',      address: '188 Smith St, Providence, RI 02908',      zipCode: '02908', consultant: 'mari-1', designExpert: 'de-nm', territory: 'MARI', isVirtual: false, isPlaceholder: false, leadSource: 'self_gen' },
  { id: 'p15', date: dateStr(-70), time: '11:30 AM',  type: 'appointment',  status: 'completed',          customer: 'Vargas Family',     address: '49 Park Ave, Towson, MD 21204',           zipCode: '21204', consultant: 'md-6',   designExpert: null,    territory: 'MD',   isVirtual: false, isPlaceholder: false, leadSource: 'paid' },
];
